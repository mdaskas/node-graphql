    ...
    implements ICustomerRepository
{
    async findAll(limit = this.defaultLimit, offset = this.defaultOffset) {
        ...
        logger.debug('CustomerRepository.findAll: Fetched customers')
    ...
    async findById(id: number) {
        ...
        logger.debug(
            `CustomerRepository.findById: ID ${id}, Code: ${customer.code}`
        )
    ...
    async findByCode(code: string) {
        ...
        logger.debug(`CustomerRepository.findByCode: Code ${code}`)
    ...
    async findByEmail(email: string) {
        ...
        logger.debug(`CustomerRepository.findByEmail: Email ${email}`)
    ...
    async create(input: CreateCustomerInput) {
        ...
        logger.debug(
            `CustomerRepository.create: Code ${input.code}, Email: ${input.email}`
        )
    ...
    async update(id: number, input: UpdateCustomerInput) {
        ...
        logger.debug(
            `CustomerRepository.update: ID ${id}, Code: ${customer.code}`
        )
